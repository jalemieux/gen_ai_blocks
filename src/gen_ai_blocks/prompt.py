...
from core_llm.completion import Completion
...
class Prompt(BaseModel):
    ...
    prompt
    master_p : str = """
    You are an expert at writing prompts for large language models (LLMs). Your task is to create a core_llm that will instruct another AI on how to perform a specific type of task provided by the user. The core_llm you write should be divided into five key sections:
