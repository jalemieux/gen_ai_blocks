...
class Completion:
    def complete(self, messages: List[Dict[str, str]], tools: List[Tool] = None) -> str:
        pass
...
class OpenAICompletion(Completion):
    ...
    def __init__(self,
        ...
        self.parse_model = parse_model or "gpt-4o-2024-08-06"
    ...
    def complete(self, messages: List[Dict[str, str]], tools: List[Tool] = None) -> str:
        completion = self.client.chat.completions.create(
            ...
            messages=self._compress_messages(messages),
            temperature=0,
            tools=[tool.dump() for tool in tools] if tools else None
        )
